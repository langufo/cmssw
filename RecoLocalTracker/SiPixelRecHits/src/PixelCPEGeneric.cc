...
LocalPoint PixelCPEGeneric::localPosition(DetParam const& theDetParam, ClusterParam& theClusterParamBase) const {
  ...
  float xPos = siPixelUtils::generic_position_formula(
      ...
      theDetParam.theTopol->RelativeFractionPixelInX(theClusterParam.theCluster->minPixelRow()),
      theDetParam.theTopol->RelativeFractionPixelInX(theClusterParam.theCluster->maxPixelRow()),
  ...
  float yPos = siPixelUtils::generic_position_formula(
      ...
      theDetParam.theTopol->RelativeFractionPixelInY(theClusterParam.theCluster->minPixelCol()),
      theDetParam.theTopol->RelativeFractionPixelInY(theClusterParam.theCluster->maxPixelCol()),
